...
import 'package:my_worker_manager/src/cancelable.dart';
...
abstract class Executor {
  ...
  Future<void> warmUp({bool log = false, int processorsNumber = 0});
...
class _Executor implements Executor {
  ...
  @override
  Future<void> warmUp({bool log = false, int processorsNumber = 0}) async {
    _log = log;
    if (processorsNumber <= 0) processorsNumber = numberOfProcessors;
