...
import 'ys_drawer_controller.dart';
...
///
/// [DrawerScaffoldState] uses this to seamlessly change transition animations
...
/// Geometry information for [DrawerScaffold] components after layout is finished.
///
/// To get a [ValueNotifier] for the scaffold geometry of a given
/// [BuildContext], use [DrawerScaffold.geometryOf].
///
...
/// [FloatingActionButton].
///
/// For information about the [DrawerScaffold]'s geometry that is used while laying
/// out the [FloatingActionButton], see [ScaffoldPrelayoutGeometry].
@immutable
class ScaffoldGeometry {
  /// Create an object that describes the geometry of a [DrawerScaffold].
  const ScaffoldGeometry({
    this.bottomNavigationBarTop,
    this.floatingActionButtonArea,
  });

  /// The distance from the [DrawerScaffold]'s top edge to the top edge of the
  /// rectangle in which the [DrawerScaffold.bottomNavigationBar] bar is laid out.
  ///
  /// Null if [DrawerScaffold.bottomNavigationBar] is null.
  final double bottomNavigationBarTop;

  /// The [DrawerScaffold.floatingActionButton]'s bounding rectangle.
  ///
...
/// * Motion animations, which are triggered by the [DrawerScaffold]
...
/// [DrawerScaffoldState] for the current [BuildContext] via [DrawerScaffold.of] and use the
/// [DrawerScaffoldState.showSnackBar] and [DrawerScaffoldState.showBottomSheet] functions.
///
/// {@tool snippet --template=stateful_widget_material}
/// This example shows a [DrawerScaffold] with a [body] and [FloatingActionButton].
/// The [body] is a [Text] placed in a [Center] in order to center the text
/// within the [DrawerScaffold]. The [FloatingActionButton] is connected to a
...
///
/// {@tool snippet --template=stateful_widget_material}
/// This example shows a [DrawerScaffold] with a blueGrey [backgroundColor], [body]
/// and [FloatingActionButton]. The [body] is a [Text] placed in a [Center] in
/// order to center the text within the [DrawerScaffold]. The [FloatingActionButton]
...
///
/// {@tool snippet --template=stateful_widget_material}
/// This example shows a [DrawerScaffold] with an [AppBar], a [BottomAppBar] and a
/// [FloatingActionButton]. The [body] is a [Text] placed in a [Center] in order
/// to center the text within the [DrawerScaffold]. The [FloatingActionButton] is
...
///  * [DrawerScaffoldState], which is the state associated with this widget.
...
class DrawerScaffold extends StatefulWidget {
  ...
  const DrawerScaffold({
    ...
    // tory add
    this.drawerOpenCallback,
    this.endDrawerOpenCallback,
    this.drawer,
    this.endDrawer,
  ...
  ///
  /// If null, the [DrawerScaffoldState] will use the default location, [FloatingActionButtonLocation.endFloat].
  final FloatingActionButtonLocation floatingActionButtonLocation;

  /// Animator to move the [floatingActionButton] to a new [floatingActionButtonLocation].
  ///
  /// If null, the [DrawerScaffoldState] will use the default animator, [FloatingActionButtonAnimator.scaling].
  ...
  /// [DrawerScaffoldState.openDrawer] function.
  ///
  /// Typically a [Drawer].
  final Widget drawer;
  ...
  ///
  /// In the uncommon case that you wish to open the drawer manually, use the
  /// [DrawerScaffoldState.openEndDrawer] function.
  ///
  /// Typically a [Drawer].
  final Widget endDrawer;

  //DF: tory add callback
  final ValueChanged<bool> drawerOpenCallback;
  final ValueChanged<bool> endDrawerOpenCallback;
  ...
  /// Typical usage of the [DrawerScaffold.of] function is to call it from within the
  /// `build` method of a child of a [DrawerScaffold].
  ///
  /// ```dart imports
  /// import 'package:flutter/material.dart';
  /// ```
  ...
  /// When the [DrawerScaffold] is actually created in the same `build` function, the
  /// `context` argument to the `build` function can't be used to find the
  /// [DrawerScaffold] (since it's "above" the widget being returned in the widget
  ...
  /// [DrawerScaffold]. In this solution, you would have an outer widget that creates
  /// the [DrawerScaffold] populated by instances of your new inner widgets, and then
  /// in these inner widgets you would use [DrawerScaffold.of].
  ///
  /// A less elegant but more expedient solution is assign a [GlobalKey] to the
  /// [DrawerScaffold], then use the `key.currentState` property to obtain the
  /// [DrawerScaffoldState] rather than using the [DrawerScaffold.of] function.
  ///
  /// If there is no [DrawerScaffold] in scope, then this will throw an exception.
  /// To return null if there is no [DrawerScaffold], then pass `nullOk: true`.
  static DrawerScaffoldState of(BuildContext context, {bool nullOk = false}) {
    assert(nullOk != null);
    assert(context != null);
    final DrawerScaffoldState result =
        context.findAncestorStateOfType<DrawerScaffoldState>();
  ...
  /// [DrawerScaffold] ancestor of the given context.
  ///
  ...
  /// paint pass.
  ///
  /// The closest [DrawerScaffold] ancestor for the context might change, e.g when
  /// an element is moved from one scaffold to another. For [StatefulWidget]s
  /// using this listenable, a change of the [DrawerScaffold] ancestor will
  /// trigger a [State.didChangeDependencies].
  ///
  /// A typical pattern for listening to the scaffold geometry would be to
  /// call [DrawerScaffold.geometryOf] in [State.didChangeDependencies], compare the
  ...
  /// [DrawerScaffold] so that the client widget gets rebuilt whenever the [hasDrawer]
  /// value changes.
  ///
  /// See also:
  ///
  ///  * [DrawerScaffold.of], which provides access to the [DrawerScaffoldState] object as a
  ...
  static bool hasDrawer(BuildContext context,
    ...
    if (registerForUpdates) {
      ...
      final DrawerScaffoldState scaffold =
          context.findAncestorStateOfType<DrawerScaffoldState>();
      return scaffold?.hasDrawer ?? false;
    }
  }
...
/// State for a [DrawerScaffold].
///
/// Can display [SnackBar]s and [BottomSheet]s. Retrieve a [DrawerScaffoldState] from
/// the current [BuildContext] using [DrawerScaffold.of].
class DrawerScaffoldState extends State<DrawerScaffold>
    with TickerProviderStateMixin {
  // DRAWER API

  final GlobalKey<YsDrawerControllerState> _drawerKey =
      GlobalKey<YsDrawerControllerState>();
  final GlobalKey<YsDrawerControllerState> _endDrawerKey =
      GlobalKey<YsDrawerControllerState>();

  /// Whether this scaffold has a non-null [DrawerScaffold.appBar].
  bool get hasAppBar => widget.appBar != null;

  /// Whether this scaffold has a non-null [DrawerScaffold.drawer].
  bool get hasDrawer => widget.drawer != null;

  /// Whether this scaffold has a non-null [DrawerScaffold.endDrawer].
  bool get hasEndDrawer => widget.endDrawer != null;

  /// Whether this scaffold has a non-null [DrawerScaffold.floatingActionButton].
  bool get hasFloatingActionButton => widget.floatingActionButton != null;

  double _appBarMaxHeight;

  /// The max height the [DrawerScaffold.appBar] uses.
  ///
  ...
  /// Whether the [DrawerScaffold.drawer] is opened.
  ///
  /// See also:
  ///
  ///  * [DrawerScaffoldState.openDrawer], which opens the [DrawerScaffold.drawer] of a
  ///    [Scaffold].
  bool get isDrawerOpen => _drawerOpened;

  /// Whether the [DrawerScaffold.endDrawer] is opened.
  ///
  /// See also:
  ///
  ///  * [DrawerScaffoldState.openEndDrawer], which opens the [DrawerScaffold.endDrawer] of
  ///    a [Scaffold].
  ...
  void _endDrawerOpenedCallback(bool isOpened) {
    print("_endDrawerOpenedCallback()... $isOpened");
    if (mounted)
      WidgetsBinding.instance.addPostFrameCallback((_) {
        setState(() {
          print("_endDrawerOpenedCallback()... real:$isOpened");
          _endDrawerOpened = isOpened;
          widget.endDrawerOpenCallback?.call(isOpened);
        });
      });
  }
  ...
  ///
  /// If the scaffold has a non-null [DrawerScaffold.drawer], this function will cause
  /// the drawer to begin its entrance animation.
  ///
  /// Normally this is not needed since the [DrawerScaffold] automatically shows an
  /// appropriate [IconButton], and handles the edge-swipe gesture, to show the
  /// drawer.
  ///
  /// To close the drawer once it is open, use [Navigator.pop].
  ///
  /// See [DrawerScaffold.of] for information about how to obtain the [DrawerScaffoldState].
  void openDrawer() {
  ...
  ///
  /// If the scaffold has a non-null [DrawerScaffold.endDrawer], this function will cause
  ...
  /// 在drawer内部使用[Navigator.pop], 这个方法在外部调用
  void closeEndDrawer() {
    // if (_drawerKey.currentState != null && _drawerOpened)
    //   _drawerKey.currentState.close();
    _endDrawerKey.currentState?.close();
  ...
  /// Shows a material design bottom sheet in the nearest [DrawerScaffold]. To show
  /// a persistent bottom sheet, use the [DrawerScaffold.bottomSheet].
  ///
  ...
  /// [ModalRoute] and a back button is added to the app bar of the [DrawerScaffold]
  /// that closes the bottom sheet.
  ///
  /// To create a persistent bottom sheet that is not a [LocalHistoryEntry] and
  /// does not add a back button to the enclosing Scaffold's app bar, use the
  /// [DrawerScaffold.bottomSheet] constructor parameter.
  ///
  /// A persistent bottom sheet shows information that supplements the primary
  /// content of the app. A persistent bottom sheet remains visible even when
  /// the user interacts with other parts of the app.
  ...
  ///    sheet.
  ///  * [DrawerScaffold.of], for information about how to obtain the [DrawerScaffoldState].
  ...
  /// [DrawerScaffold.floatingActionButton].
  ...
  /// [DrawerScaffold.floatingActionButton].  This value must not be null.
  ...
  /// Shows the [DrawerScaffold.floatingActionButton].
  ...
  void _handleStatusBarTap() {
    if (_primaryScrollController.hasClients) {
      _primaryScrollController.animateTo(
        ...
        curve: Curves.linear, //Use a more appropriate curve.
      );
    }
  }
  ...
  @override
  void didUpdateWidget(DrawerScaffold oldWidget) {
    ...
    if (widget.drawer != null) {
      ...
      _addIfNonNull(
        ...
        YsDrawerController(
          ...
          child: widget.drawer,
          drawerCallback: (b) {
            widget.drawerOpenCallback?.call(b);
            _drawerOpenedCallback?.call(b);
          },
          dragStartBehavior: widget.drawerDragStartBehavior,
          scrimColor: widget.drawerScrimColor,
          edgeDragWidth: widget.drawerEdgeDragWidth,
...
/// An interface for controlling a feature of a [DrawerScaffold].
///
/// Commonly obtained from [DrawerScaffoldState.showSnackBar] or [DrawerScaffoldState.showBottomSheet].
...
class _StandardBottomSheetState extends State<_StandardBottomSheet> {
  ...
  bool extentChanged(DraggableScrollableNotification notification) {
    ...
    final DrawerScaffoldState scaffold = DrawerScaffold.of(context);
...
///
/// This is the type of objects returned by [DrawerScaffoldState.showBottomSheet].
///
