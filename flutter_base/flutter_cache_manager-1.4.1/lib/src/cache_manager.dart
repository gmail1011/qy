...
import 'package:my_flutter_cache_manager/src/compat/file_service_compat.dart';
import 'package:my_flutter_cache_manager/src/result/download_progress.dart';
...
import 'package:my_flutter_cache_manager/src/storage/non_storing_object_provider.dart';
import 'package:my_flutter_cache_manager/src/web/file_service.dart';
import 'package:my_flutter_cache_manager/src/web/web_helper.dart';
...
abstract class BaseCacheManager {
  ...
  Future<void> _pushFileToStream(StreamController streamController, String url,
    ...
    try {
      ...
      if (cacheFile != null) {
        print('CacheManager: 找到缓存文件$url  cacheFile:${cacheFile.file.path}');
  ...
  Future<File> putFile(
    ...
    // cacheObject ??= CacheObject(url, relativePath: '${getCacheKey(url)}');
