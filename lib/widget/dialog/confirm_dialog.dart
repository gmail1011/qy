                ...
                children: <Widget>[
                  ...
                  Visibility(
                    ...
                    child: Padding(
                      ...
                      child: getHengLine(w: Dimens.pt260, color: Colors.white.withOpacity(0.1)),
                    ),
                  ),
                  // content
                  Visibility(
                    ...
                    children: <Widget>[
                      Visibility(
                        ...
                        child: getLinearGradientBtn(cancelText,
                            width: Dimens.pt110,
                            height: Dimens.pt35,
                            enableColors: [Colors.white.withOpacity(0.3), Colors.white.withOpacity(0.3)],
                      ...
                      getLinearGradientBtn(sureText,
                          ...
                          height: Dimens.pt35,
                          enableColors: [AppColors.primaryTextColor, AppColors.primaryTextColor],
