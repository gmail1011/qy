...
class CustomRefreshFooter extends Footer {
  ...
  Widget contentBuilder(
      ...
      bool success,
      bool noMore) {
    return CustomRefreshFooterWidget(
      key: key,
...
/// 经典Footer组件
class CustomRefreshFooterWidget extends StatefulWidget {
  final CustomRefreshFooter classicalFooter;
  ...
  @override
  CustomRefreshFooterWidgetState createState() => CustomRefreshFooterWidgetState();
}

class CustomRefreshFooterWidgetState extends State<CustomRefreshFooterWidget>
    with TickerProviderStateMixin<CustomRefreshFooterWidget> {
  // 是否到达触发加载距离
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
              _showText,
              style: TextStyle(
                fontSize: widget.classicalFooter.fontSize,
                color: widget.classicalFooter.textColor,
              ),
            ),
