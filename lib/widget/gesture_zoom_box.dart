...
typedef LimitCallback = void Function(bool limit); //禁止滑动
...
class GestureZoomBox extends StatefulWidget {
  ...
  final LimitCallback limitCallback;
...
class _GestureZoomBoxState extends State<GestureZoomBox>
    ...
    return Transform(
      ...
      child: Listener(
        ...
        child: GestureDetector(
          onTap: _scale > 1.0 ? () {} : widget.onPressed,
          onDoubleTap: _onDoubleTap,
          onScaleStart: _onScaleStart,
          onScaleUpdate: _onScaleUpdate,
          onScaleEnd: _onScaleEnd,
          onVerticalDragEnd: _scale > 1.0 ? null : _onVerticalDragEnd,
  ...
  _onVerticalDragEnd(DragEndDetails details) {
    ...
    if ((details?.velocity?.pixelsPerSecond?.distance ?? 0) > 100) {
      widget.onPressed();
    }
  ...
  _onScaleEnd(ScaleEndDetails details) {
    ...
    ///回调是否禁止滑动banner
    widget.limitCallback(_scale > 1.0);
  }
