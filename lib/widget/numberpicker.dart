...
class NumberPicker extends StatelessWidget {
  ...
  Widget _integerListView(ThemeData themeData) {
    ...
    var listItemCount = selectBean.length + 2;
                      ...
                      : GestureDetector(
                          ...
                          child: Center(
                            child: Text(
                              ...
                              selectBean[index -1].popDays.toString() + "天",
                              style: itemStyle,
                            ),
                          ),
                        );
              ...
              InfiniteListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return Center(
                    child: Text(
                      //getDisplayedValue(value),
                      selectBean[index].popDays.toString() + "天",
                      style: itemStyle,
                    ),
                  );
                },
