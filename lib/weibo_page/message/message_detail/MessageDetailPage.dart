...
class _MessageDetailPageState extends State<MessageDetailPage> {
  ...
  StreamController<List<ListElement>> _listViewStreamController =
  ...
  void _initData() async {
    try {
      l.e("_initData", "请求数据");
      dynamic messageDetail = await netManager.client.getMessageDetail(
          _pageNumber, _pageSize, widget._messageListDataList?.sessionId);
  ...
  void _sendMessage() async {
    try {
      ...
      isSending = true;
      setState(() {});
      await netManager.client.sendMessage(
          widget._messageListDataList?.userId, _textEditingController?.text);
  ...
  void _sendImageMessage() async {
    try {
      ...
      await netManager.client
          .sendImageMessage(widget._messageListDataList?.userId, remotePIcList);
                          ...
                          return pullYsRefresh(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                ///是否我的发言
                                bool isMine = _messageList[index]?.sendUid ==
                                    GlobalStore.getMe().uid;
                                String content = _messageList[index]?.content;
                                String imageUrl;
                                if (_messageList[index]?.imgUrl != null &&
                                    _messageList[index].imgUrl.length > 0) {
                                ...
                                return isMine
                                    ? _buildMessageRightItemUI(
                                        ...
                                        imageUrl,
                                        localUrl,
                                        _messageList[index].sendAvatar,
                                        _messageList[index].sendUid)
          ...
          bottomSheet: Container(
            ...
            child: Row(
              children: [
                GestureDetector(
                  child: Container(
                    margin: EdgeInsets.only(bottom: 22, right: 5),
                    child: isSending
                        ? SizedBox(
                            width: 24.w,
                            height: 24.w,
                  ...
                  onTap: () async {
                    ...
                    MultiImageModel multiImageModel =
                        await taskManager.addTaskToQueue(
                            MultiImageUploadTask(list),
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        focusedBorder: OutlineInputBorder(
                          borderSide:
                              BorderSide(color: Color.fromRGBO(44, 44, 44, 1)),
                          borderRadius: BorderRadius.circular(26),
                        ),
                      ),
                    ),
...
///私信列表 UI-其他人的发言
Widget _buildMessageLeftItemUI(String content, String imageUrl, String localUrl,
        String headImage, int userId) =>
    Container(
        alignment: Alignment.centerLeft,
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              child: Container(
                child: Bubble(
                    borderRadius: (content == null || content == "")
                        ? Radius.circular(4)
                        : Radius.circular(12),
                    padding: (content == null || content == "")
                        ? EdgeInsets.only(
                            top: 12.w, bottom: 12.w, left: 16.w, right: 16.w)
                        ...
                        ? GestureDetector(
                            child: Container(
                              ...
                              child: (localUrl == null || localUrl == "")
                                  ? CachedNetworkImage(
                                      imageUrl: path.join(
                                          Address.baseImagePath ?? '', imageUrl),
                                      fit: BoxFit.fitWidth,
                            ...
                            onTap: () {
                              Gets.Get.to(
                                  () => BigImageViewPage(imageUrl: imageUrl),
                                  opaque: false);
                            },
                          )
                        : Text(
                            ...
                            softWrap: true,
                            style: TextStyle(
                                fontSize: 16.w, color: Colors.white, height: 1.5),
                          )),
              ),
            ),
          ],
...
///私信列表 UI- 我的发言
Widget _buildMessageRightItemUI(String content, String imageUrl,
        String localUrl, String headImage, int userId) =>
    Container(
        alignment: Alignment.centerRight,
        margin: EdgeInsets.only(bottom: 29.w, left: 16.w, right: 16.w),
        child: Row(
