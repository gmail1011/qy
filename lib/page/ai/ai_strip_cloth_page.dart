            ...
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (BuildContext context) =>
                      AITotalPage(tabController.index)));
            },
            child: Container(
                ...
                return Container(
                  child: Container(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          // width: index==0?111:index==1?143:143,
                          ...
                          child: Row(
                            ...
                            children: [
                              Image.asset(
                                index == 0
                                    ? "assets/weibo/hjll_ai_address.png"
                                    : index == 1
                                        ? "assets/weibo/hjll_ai_video_face.png"
                                        : "assets/weibo/hjll_ai_pic_face.png",
                                width: 26,
                                height: 26,
                              ),
                              Text(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          (wallet.aiUndressFreeTimes > 0)
                                              ? Text(
                                                  "免费次数${wallet.aiUndressFreeTimes}",
                                                  style: TextStyle(
                        ...
                        child: Container(
                          child: Column(
                            ...
                            children: [
                              SizedBox(height: 12),
                              aiModList == null ||
                                      aiModList.aiChangeFaceVideoMod == null ||
                                      (aiModList.aiChangeFaceVideoMod.length ??
                                              0) ==
                                          0
                                  ? Container()
                                  : Container(
                        ...
                        child: Container(
                          child: Column(
                            ...
                            children: [
                              SizedBox(height: 12),
                              aiModList == null ||
                                      aiModList.aiChangeFaceMod == null ||
                                      (aiModList.aiChangeFaceMod.length ?? 0) ==
                                          0
                                  ? Container()
                                  : Container(
                                      padding:
