...
import 'package:flutter_app/page/wallet/game_detail_page/simple_details/page.dart';
...
Widget buildView(
  ...
  return FullBg(
    child: Scaffold(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Expanded(
              ...
              child: TabBarView(
                children: <Widget>[
                  //GameWithdrawDetailsPage().buildPage({"type": 0}),
                  GameWithdrawDetailsPage().buildPage({"type": 1}),
                ],
              ),
            ),
          ],
      ...
      body: GameWithdrawDetailsPage().buildPage({"type": 1}),
    ),
  );
}
