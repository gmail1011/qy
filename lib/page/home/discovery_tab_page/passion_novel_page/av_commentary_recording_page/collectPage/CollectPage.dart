...
class _CollectPageState extends State<CollectPage>{
  ...
  void initData(bool isLoading) async {
    dynamic model = await netManager.client.getAVCommentaryCollectList(pageNumber, pageSize, GlobalStore.getMe().uid, 'avcomment');
    if(model != null){
      avCommentaryEntity = new AVCommentaryData().fromJson(model);
      //avCommentaryEntity = Config.avCommentaryEntity;
