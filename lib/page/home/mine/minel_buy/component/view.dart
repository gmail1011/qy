...
Widget buildView(
    MineBuyItemState state, Dispatch dispatch, ViewService viewService) {
  return GestureDetector(
    onTap: () {
      dispatch(MineBuyItemActionCreator.onTapItem(state.uniqueId));
    },
    onLongPress: () async {
      var datas = <ItemData>[
      ...
      if (pos == 0) {
        dispatch(MineBuyPostActionCreator.onDelBuyItem(state));
      }
    },
    child: Stack(
