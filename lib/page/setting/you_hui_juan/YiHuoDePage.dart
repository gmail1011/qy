...
class YiHuoDePage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _YiHuoDePageState();
  }
}

class _YiHuoDePageState extends State<YiHuoDePage> {
  int page = 1;
  int count = 10;
  ...
  Future initData() async {
    try {
      List<dynamic> lists =
          await netManager.client.getYouHuiJuan(2, page, count);
                                      ...
                                      onTap: () {
                                        ...
                                        if (data[index].goodsType == 1) {
                                          ...
                                          if (GlobalStore.isRechargeVIP() &&
                                              (GlobalStore.getMe()?.vipLevel ==
                                                      1 ||
                                                  GlobalStore.getMe()
                                                          ?.vipLevel ==
                                                      2) &&
                                              (DateTime.parse(GlobalStore.getMe()
                                                                      ?.vipExpireDate ??
                                                                  "")
                                                              .year -
                                                          netManager
