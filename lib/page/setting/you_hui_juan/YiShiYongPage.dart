...
class YiShiYongPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _YiShiYongPageState();
  }
}

class _YiShiYongPageState extends State<YiShiYongPage> {
  int page = 1;
  int count = 10;
  ...
  Future initData() async {
    try {
      List<dynamic> lists =
          await netManager.client.getYouHuiJuan(1, page, count);
      if (page == 1) {
        data.clear();
