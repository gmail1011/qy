...
///历史记录UI
Widget buildView(
    HistoryRecordsState state, Dispatch dispatch, ViewService viewService) {
  ...
  return FullBg(
    child: Scaffold(
        ...
        actions: [
          GestureDetector(
            onTap: () => viewService.broadcast(
                HistoryRecordsActionCreator.changeEditState(
      ...
      body: TabBarView(
        ...
        children: [
          LongVideoPage()
              .buildPage({"type": ModuleType.LONG_VIDEO_HISTORY_RECORDS}),
          ShortVideoPage()
              .buildPage({"type": ModuleType.SHORT_VIDEO_HISTORY_RECORDS}),
        ],
