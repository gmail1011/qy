...
guessLikeEntityFromJson(GuessLikeEntity data, Map<String, dynamic> json) {
	if (json['code'] != null) {
	...
	if (json['data'] != null) {
		data.data = GuessLikeData().fromJson(json['data']);
	}
	if (json['hash'] != null) {
		data.hash = json['hash'];
	}
...
Map<String, dynamic> guessLikeEntityToJson(GuessLikeEntity entity) {
...
guessLikeDataFromJson(GuessLikeData data, Map<String, dynamic> json) {
	if (json['list'] != null) {
		data.xList = (json['list'] as List).map((v) => GuessLikeDataList().fromJson(v)).toList();
	}
...
Map<String, dynamic> guessLikeDataToJson(GuessLikeData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
guessLikeDataListFromJson(GuessLikeDataList data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
	...
	if (json['upTag'] != null) {
		data.upTag = json['upTag'].toString();
	}
	...
	if (json['awards'] != null) {
		data.awards = (json['awards'] as List).map((v) => v is String
				? int.tryParse(v)
				: v.toInt()).toList().cast<int>();
	}
	if (json['awardsImage'] != null) {
		data.awardsImage = (json['awardsImage'] as List).map((v) => v.toString()).toList().cast<String>();
	}
	if (json['vInfos'] != null) {
		data.vInfos = (json['vInfos'] as List).map((v) => GuessLikeDataListVInfos().fromJson(v)).toList();
	}
	return data;
}

Map<String, dynamic> guessLikeDataListToJson(GuessLikeDataList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	...
	data['awardsImage'] = entity.awardsImage;
	data['vInfos'] =  entity.vInfos?.map((v) => v.toJson())?.toList();
	return data;
}

guessLikeDataListVInfosFromJson(GuessLikeDataListVInfos data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['tags'] != null) {
		data.tags = (json['tags'] as List).map((v) => GuessLikeDataListVInfosTags().fromJson(v)).toList();
	}
	...
	if (json['publisher'] != null) {
		data.publisher = GuessLikeDataListVInfosPublisher().fromJson(json['publisher']);
	}
	if (json['location'] != null) {
		data.location = GuessLikeDataListVInfosLocation().fromJson(json['location']);
	}
	if (json['vidStatus'] != null) {
		data.vidStatus = GuessLikeDataListVInfosVidStatus().fromJson(json['vidStatus']);
	}
	if (json['comment'] != null) {
		data.comment = GuessLikeDataListVInfosComment().fromJson(json['comment']);
	}
	if (json['watch'] != null) {
		data.watch = GuessLikeDataListVInfosWatch().fromJson(json['watch']);
	}
...
Map<String, dynamic> guessLikeDataListVInfosToJson(GuessLikeDataListVInfos entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
guessLikeDataListVInfosTagsFromJson(GuessLikeDataListVInfosTags data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['name'] != null) {
...
Map<String, dynamic> guessLikeDataListVInfosTagsToJson(GuessLikeDataListVInfosTags entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
	data['name'] = entity.name;
...
guessLikeDataListVInfosPublisherFromJson(GuessLikeDataListVInfosPublisher data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
		data.uid = json['uid'] is String
				? int.tryParse(json['uid'])
				: json['uid'].toInt();
...
Map<String, dynamic> guessLikeDataListVInfosPublisherToJson(GuessLikeDataListVInfosPublisher entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
	data['gender'] = entity.gender;
...
guessLikeDataListVInfosLocationFromJson(GuessLikeDataListVInfosLocation data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['city'] != null) {
...
Map<String, dynamic> guessLikeDataListVInfosLocationToJson(GuessLikeDataListVInfosLocation entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
guessLikeDataListVInfosVidStatusFromJson(GuessLikeDataListVInfosVidStatus data, Map<String, dynamic> json) {
...
Map<String, dynamic> guessLikeDataListVInfosVidStatusToJson(GuessLikeDataListVInfosVidStatus entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
guessLikeDataListVInfosCommentFromJson(GuessLikeDataListVInfosComment data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
		data.uid = json['uid'] is String
				? int.tryParse(json['uid'])
				: json['uid'].toInt();
...
Map<String, dynamic> guessLikeDataListVInfosCommentToJson(GuessLikeDataListVInfosComment entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
	data['portrait'] = entity.portrait;
...
guessLikeDataListVInfosWatchFromJson(GuessLikeDataListVInfosWatch data, Map<String, dynamic> json) {
...
Map<String, dynamic> guessLikeDataListVInfosWatchToJson(GuessLikeDataListVInfosWatch entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
