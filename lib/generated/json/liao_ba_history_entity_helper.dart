...
liaoBaHistoryEntityFromJson(LiaoBaHistoryEntity data, Map<String, dynamic> json) {
	if (json['code'] != null) {
	...
	if (json['data'] != null) {
		data.data = LiaoBaHistoryData().fromJson(json['data']);
	}
	if (json['hash'] != null) {
		data.hash = json['hash'];
	}
...
Map<String, dynamic> liaoBaHistoryEntityToJson(LiaoBaHistoryEntity entity) {
...
liaoBaHistoryDataFromJson(LiaoBaHistoryData data, Map<String, dynamic> json) {
	if (json['workList'] != null) {
		data.workList = (json['workList'] as List).map((v) => LiaoBaHistoryDataWorkList().fromJson(v)).toList();
	}
...
Map<String, dynamic> liaoBaHistoryDataToJson(LiaoBaHistoryData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
liaoBaHistoryDataWorkListFromJson(LiaoBaHistoryDataWorkList data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['tags'] != null) {
		data.tags = (json['tags'] as List).map((v) => LiaoBaHistoryDataWorkListTags().fromJson(v)).toList();
	}
	...
	if (json['publisher'] != null) {
		data.publisher = LiaoBaHistoryDataWorkListPublisher().fromJson(json['publisher']);
	}
	if (json['location'] != null) {
		data.location = LiaoBaHistoryDataWorkListLocation().fromJson(json['location']);
	}
	if (json['vidStatus'] != null) {
		data.vidStatus = LiaoBaHistoryDataWorkListVidStatus().fromJson(json['vidStatus']);
	}
	if (json['comment'] != null) {
		data.comment = LiaoBaHistoryDataWorkListComment().fromJson(json['comment']);
	}
	if (json['watch'] != null) {
		data.watch = LiaoBaHistoryDataWorkListWatch().fromJson(json['watch']);
	}
	return data;
}

Map<String, dynamic> liaoBaHistoryDataWorkListToJson(LiaoBaHistoryDataWorkList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
liaoBaHistoryDataWorkListTagsFromJson(LiaoBaHistoryDataWorkListTags data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['name'] != null) {
...
Map<String, dynamic> liaoBaHistoryDataWorkListTagsToJson(LiaoBaHistoryDataWorkListTags entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
liaoBaHistoryDataWorkListPublisherFromJson(LiaoBaHistoryDataWorkListPublisher data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
...
Map<String, dynamic> liaoBaHistoryDataWorkListPublisherToJson(LiaoBaHistoryDataWorkListPublisher entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
...
liaoBaHistoryDataWorkListLocationFromJson(LiaoBaHistoryDataWorkListLocation data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['city'] != null) {
...
Map<String, dynamic> liaoBaHistoryDataWorkListLocationToJson(LiaoBaHistoryDataWorkListLocation entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
liaoBaHistoryDataWorkListVidStatusFromJson(LiaoBaHistoryDataWorkListVidStatus data, Map<String, dynamic> json) {
...
Map<String, dynamic> liaoBaHistoryDataWorkListVidStatusToJson(LiaoBaHistoryDataWorkListVidStatus entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
liaoBaHistoryDataWorkListCommentFromJson(LiaoBaHistoryDataWorkListComment data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
		data.uid = json['uid'] is String
				? int.tryParse(json['uid'])
				: json['uid'].toInt();
...
Map<String, dynamic> liaoBaHistoryDataWorkListCommentToJson(LiaoBaHistoryDataWorkListComment entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
	data['portrait'] = entity.portrait;
...
liaoBaHistoryDataWorkListWatchFromJson(LiaoBaHistoryDataWorkListWatch data, Map<String, dynamic> json) {
...
Map<String, dynamic> liaoBaHistoryDataWorkListWatchToJson(LiaoBaHistoryDataWorkListWatch entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
