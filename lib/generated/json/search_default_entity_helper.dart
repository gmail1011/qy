...
searchDefaultEntityFromJson(SearchDefaultEntity data, Map<String, dynamic> json) {
	...
	if (json['data'] != null) {
		data.data = SearchDefaultData().fromJson(json['data']);
	}
	if (json['hash'] != null) {
		data.hash = json['hash'];
	}
...
searchDefaultDataFromJson(SearchDefaultData data, Map<String, dynamic> json) {
	if (json['list'] != null) {
		data.xList = (json['list'] as List).map((v) => SearchDefaultDataList().fromJson(v)).toList();
	}
	return data;
}
...
searchDefaultDataListFromJson(SearchDefaultDataList data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['tags'] != null) {
		data.tags = (json['tags'] as List).map((v) => SearchDefaultDataListTags().fromJson(v)).toList();
	}
	...
	if (json['publisher'] != null) {
		data.publisher = SearchDefaultDataListPublisher().fromJson(json['publisher']);
	}
	if (json['location'] != null) {
		data.location = SearchDefaultDataListLocation().fromJson(json['location']);
	}
	if (json['vidStatus'] != null) {
		data.vidStatus = SearchDefaultDataListVidStatus().fromJson(json['vidStatus']);
	}
	if (json['comment'] != null) {
		data.comment = SearchDefaultDataListComment().fromJson(json['comment']);
	}
	if (json['watch'] != null) {
		data.watch = SearchDefaultDataListWatch().fromJson(json['watch']);
	}
...
Map<String, dynamic> searchDefaultDataListToJson(SearchDefaultDataList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
searchDefaultDataListTagsFromJson(SearchDefaultDataListTags data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['name'] != null) {
...
Map<String, dynamic> searchDefaultDataListTagsToJson(SearchDefaultDataListTags entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
searchDefaultDataListPublisherFromJson(SearchDefaultDataListPublisher data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
...
Map<String, dynamic> searchDefaultDataListPublisherToJson(SearchDefaultDataListPublisher entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
...
searchDefaultDataListLocationFromJson(SearchDefaultDataListLocation data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['city'] != null) {
...
Map<String, dynamic> searchDefaultDataListLocationToJson(SearchDefaultDataListLocation entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
searchDefaultDataListVidStatusFromJson(SearchDefaultDataListVidStatus data, Map<String, dynamic> json) {
...
Map<String, dynamic> searchDefaultDataListVidStatusToJson(SearchDefaultDataListVidStatus entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
searchDefaultDataListCommentFromJson(SearchDefaultDataListComment data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
		data.uid = json['uid'] is String
				? int.tryParse(json['uid'])
				: json['uid'].toInt();
...
Map<String, dynamic> searchDefaultDataListCommentToJson(SearchDefaultDataListComment entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
	data['portrait'] = entity.portrait;
...
searchDefaultDataListWatchFromJson(SearchDefaultDataListWatch data, Map<String, dynamic> json) {
...
Map<String, dynamic> searchDefaultDataListWatchToJson(SearchDefaultDataListWatch entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
