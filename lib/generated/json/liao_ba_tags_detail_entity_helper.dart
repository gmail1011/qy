...
liaoBaTagsDetailEntityFromJson(LiaoBaTagsDetailEntity data, Map<String, dynamic> json) {
	if (json['code'] != null) {
	...
	if (json['data'] != null) {
		data.data = LiaoBaTagsDetailData().fromJson(json['data']);
	}
	if (json['hash'] != null) {
		data.hash = json['hash'];
	}
...
Map<String, dynamic> liaoBaTagsDetailEntityToJson(LiaoBaTagsDetailEntity entity) {
...
liaoBaTagsDetailDataFromJson(LiaoBaTagsDetailData data, Map<String, dynamic> json) {
	if (json['videos'] != null) {
		data.videos = (json['videos'] as List).map((v) => LiaoBaTagsDetailDataVideos().fromJson(v)).toList();
	}
	if (json['hasNext'] != null) {
		data.hasNext = json['hasNext'];
	}
	if (json['originalBloggerInfo'] != null) {
		data.originalBloggerInfo = LiaoBaTagsDetailDataOriginalBloggerInfo().fromJson(json['originalBloggerInfo']);
	}
...
Map<String, dynamic> liaoBaTagsDetailDataToJson(LiaoBaTagsDetailData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
liaoBaTagsDetailDataVideosFromJson(LiaoBaTagsDetailDataVideos data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['tags'] != null) {
		data.tags = (json['tags'] as List).map((v) => LiaoBaTagsDetailDataVideosTags().fromJson(v)).toList();
	}
	...
	if (json['publisher'] != null) {
		data.publisher = LiaoBaTagsDetailDataVideosPublisher().fromJson(json['publisher']);
	}
	if (json['location'] != null) {
		data.location = LiaoBaTagsDetailDataVideosLocation().fromJson(json['location']);
	}
	if (json['vidStatus'] != null) {
		data.vidStatus = LiaoBaTagsDetailDataVideosVidStatus().fromJson(json['vidStatus']);
	}
	if (json['comment'] != null) {
		data.comment = LiaoBaTagsDetailDataVideosComment().fromJson(json['comment']);
	}
	if (json['watch'] != null) {
		data.watch = LiaoBaTagsDetailDataVideosWatch().fromJson(json['watch']);
	}
	return data;
}

Map<String, dynamic> liaoBaTagsDetailDataVideosToJson(LiaoBaTagsDetailDataVideos entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
liaoBaTagsDetailDataVideosTagsFromJson(LiaoBaTagsDetailDataVideosTags data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['name'] != null) {
...
Map<String, dynamic> liaoBaTagsDetailDataVideosTagsToJson(LiaoBaTagsDetailDataVideosTags entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
liaoBaTagsDetailDataVideosPublisherFromJson(LiaoBaTagsDetailDataVideosPublisher data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
...
Map<String, dynamic> liaoBaTagsDetailDataVideosPublisherToJson(LiaoBaTagsDetailDataVideosPublisher entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
...
liaoBaTagsDetailDataVideosLocationFromJson(LiaoBaTagsDetailDataVideosLocation data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['city'] != null) {
...
Map<String, dynamic> liaoBaTagsDetailDataVideosLocationToJson(LiaoBaTagsDetailDataVideosLocation entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
liaoBaTagsDetailDataVideosVidStatusFromJson(LiaoBaTagsDetailDataVideosVidStatus data, Map<String, dynamic> json) {
...
Map<String, dynamic> liaoBaTagsDetailDataVideosVidStatusToJson(LiaoBaTagsDetailDataVideosVidStatus entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
liaoBaTagsDetailDataVideosCommentFromJson(LiaoBaTagsDetailDataVideosComment data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
		data.uid = json['uid'] is String
				? int.tryParse(json['uid'])
				: json['uid'].toInt();
...
Map<String, dynamic> liaoBaTagsDetailDataVideosCommentToJson(LiaoBaTagsDetailDataVideosComment entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
	data['portrait'] = entity.portrait;
...
liaoBaTagsDetailDataVideosWatchFromJson(LiaoBaTagsDetailDataVideosWatch data, Map<String, dynamic> json) {
...
Map<String, dynamic> liaoBaTagsDetailDataVideosWatchToJson(LiaoBaTagsDetailDataVideosWatch entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
liaoBaTagsDetailDataOriginalBloggerInfoFromJson(LiaoBaTagsDetailDataOriginalBloggerInfo data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
		data.uid = json['uid'] is String
				? int.tryParse(json['uid'])
				: json['uid'].toInt();
...
Map<String, dynamic> liaoBaTagsDetailDataOriginalBloggerInfoToJson(LiaoBaTagsDetailDataOriginalBloggerInfo entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
	data['portrait'] = entity.portrait;
