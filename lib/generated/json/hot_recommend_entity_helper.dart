...
hotRecommendEntityFromJson(HotRecommendEntity data, Map<String, dynamic> json) {
	if (json['code'] != null) {
	...
	if (json['data'] != null) {
		data.data = HotRecommendData().fromJson(json['data']);
	}
	if (json['hash'] != null) {
		data.hash = json['hash'];
	}
...
Map<String, dynamic> hotRecommendEntityToJson(HotRecommendEntity entity) {
...
hotRecommendDataFromJson(HotRecommendData data, Map<String, dynamic> json) {
	if (json['list'] != null) {
		data.xList = (json['list'] as List).map((v) => HotRecommendDataList().fromJson(v)).toList();
	}
	return data;
}

Map<String, dynamic> hotRecommendDataToJson(HotRecommendData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['list'] =  entity.xList?.map((v) => v.toJson())?.toList();
	return data;
}

hotRecommendDataListFromJson(HotRecommendDataList data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['tags'] != null) {
		data.tags = (json['tags'] as List).map((v) => HotRecommendDataListTags().fromJson(v)).toList();
	}
	...
	if (json['publisher'] != null) {
		data.publisher = HotRecommendDataListPublisher().fromJson(json['publisher']);
	}
	if (json['location'] != null) {
		data.location = HotRecommendDataListLocation().fromJson(json['location']);
	}
	if (json['vidStatus'] != null) {
		data.vidStatus = HotRecommendDataListVidStatus().fromJson(json['vidStatus']);
	}
	if (json['comment'] != null) {
		data.comment = HotRecommendDataListComment().fromJson(json['comment']);
	}
	if (json['watch'] != null) {
		data.watch = HotRecommendDataListWatch().fromJson(json['watch']);
	}
...
Map<String, dynamic> hotRecommendDataListToJson(HotRecommendDataList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
hotRecommendDataListTagsFromJson(HotRecommendDataListTags data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['name'] != null) {
...
Map<String, dynamic> hotRecommendDataListTagsToJson(HotRecommendDataListTags entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
hotRecommendDataListPublisherFromJson(HotRecommendDataListPublisher data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
...
Map<String, dynamic> hotRecommendDataListPublisherToJson(HotRecommendDataListPublisher entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
...
hotRecommendDataListLocationFromJson(HotRecommendDataListLocation data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['city'] != null) {
...
Map<String, dynamic> hotRecommendDataListLocationToJson(HotRecommendDataListLocation entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
hotRecommendDataListVidStatusFromJson(HotRecommendDataListVidStatus data, Map<String, dynamic> json) {
...
Map<String, dynamic> hotRecommendDataListVidStatusToJson(HotRecommendDataListVidStatus entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
hotRecommendDataListCommentFromJson(HotRecommendDataListComment data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
		data.uid = json['uid'] is String
				? int.tryParse(json['uid'])
				: json['uid'].toInt();
...
Map<String, dynamic> hotRecommendDataListCommentToJson(HotRecommendDataListComment entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
	data['portrait'] = entity.portrait;
...
hotRecommendDataListWatchFromJson(HotRecommendDataListWatch data, Map<String, dynamic> json) {
...
Map<String, dynamic> hotRecommendDataListWatchToJson(HotRecommendDataListWatch entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
