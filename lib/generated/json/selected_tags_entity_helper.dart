...
selectedTagsEntityFromJson(SelectedTagsEntity data, Map<String, dynamic> json) {
	if (json['code'] != null) {
	...
	if (json['data'] != null) {
		data.data = SelectedTagsData().fromJson(json['data']);
	}
	if (json['hash'] != null) {
		data.hash = json['hash'];
	}
...
Map<String, dynamic> selectedTagsEntityToJson(SelectedTagsEntity entity) {
...
selectedTagsDataFromJson(SelectedTagsData data, Map<String, dynamic> json) {
	if (json['list'] != null) {
		data.xList = (json['list'] as List).map((v) => SelectedTagsDataList().fromJson(v)).toList();
	}
...
Map<String, dynamic> selectedTagsDataToJson(SelectedTagsData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
selectedTagsDataListFromJson(SelectedTagsDataList data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['tags'] != null) {
		data.tags = (json['tags'] as List).map((v) => SelectedTagsDataListTags().fromJson(v)).toList();
	}
	...
	if (json['publisher'] != null) {
		data.publisher = SelectedTagsDataListPublisher().fromJson(json['publisher']);
	}
	if (json['location'] != null) {
		data.location = SelectedTagsDataListLocation().fromJson(json['location']);
	}
	if (json['vidStatus'] != null) {
		data.vidStatus = SelectedTagsDataListVidStatus().fromJson(json['vidStatus']);
	}
	if (json['comment'] != null) {
		data.comment = SelectedTagsDataListComment().fromJson(json['comment']);
	}
	if (json['watch'] != null) {
		data.watch = SelectedTagsDataListWatch().fromJson(json['watch']);
	}
	return data;
}

Map<String, dynamic> selectedTagsDataListToJson(SelectedTagsDataList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
selectedTagsDataListTagsFromJson(SelectedTagsDataListTags data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['name'] != null) {
...
Map<String, dynamic> selectedTagsDataListTagsToJson(SelectedTagsDataListTags entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
selectedTagsDataListPublisherFromJson(SelectedTagsDataListPublisher data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
...
Map<String, dynamic> selectedTagsDataListPublisherToJson(SelectedTagsDataListPublisher entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
...
selectedTagsDataListLocationFromJson(SelectedTagsDataListLocation data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['city'] != null) {
...
Map<String, dynamic> selectedTagsDataListLocationToJson(SelectedTagsDataListLocation entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
selectedTagsDataListVidStatusFromJson(SelectedTagsDataListVidStatus data, Map<String, dynamic> json) {
...
Map<String, dynamic> selectedTagsDataListVidStatusToJson(SelectedTagsDataListVidStatus entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
selectedTagsDataListCommentFromJson(SelectedTagsDataListComment data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
		data.uid = json['uid'] is String
				? int.tryParse(json['uid'])
				: json['uid'].toInt();
...
Map<String, dynamic> selectedTagsDataListCommentToJson(SelectedTagsDataListComment entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
	data['portrait'] = entity.portrait;
...
selectedTagsDataListWatchFromJson(SelectedTagsDataListWatch data, Map<String, dynamic> json) {
...
Map<String, dynamic> selectedTagsDataListWatchToJson(SelectedTagsDataListWatch entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
