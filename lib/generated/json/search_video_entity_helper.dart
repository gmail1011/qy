...
searchVideoEntityFromJson(SearchVideoEntity data, Map<String, dynamic> json) {
	if (json['code'] != null) {
	...
	if (json['data'] != null) {
		data.data = SearchVideoData().fromJson(json['data']);
	}
	if (json['hash'] != null) {
		data.hash = json['hash'];
	}
...
Map<String, dynamic> searchVideoEntityToJson(SearchVideoEntity entity) {
...
searchVideoDataFromJson(SearchVideoData data, Map<String, dynamic> json) {
	if (json['list'] != null) {
		data.xList = (json['list'] as List).map((v) => SearchVideoDataList().fromJson(v)).toList();
	}
...
Map<String, dynamic> searchVideoDataToJson(SearchVideoData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
searchVideoDataListFromJson(SearchVideoDataList data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['tags'] != null) {
		data.tags = (json['tags'] as List).map((v) => SearchVideoDataListTags().fromJson(v)).toList();
	}
	...
	if (json['publisher'] != null) {
		data.publisher = SearchVideoDataListPublisher().fromJson(json['publisher']);
	}
	if (json['location'] != null) {
		data.location = SearchVideoDataListLocation().fromJson(json['location']);
	}
	if (json['vidStatus'] != null) {
		data.vidStatus = SearchVideoDataListVidStatus().fromJson(json['vidStatus']);
	}
	if (json['comment'] != null) {
		data.comment = SearchVideoDataListComment().fromJson(json['comment']);
	}
	if (json['watch'] != null) {
		data.watch = SearchVideoDataListWatch().fromJson(json['watch']);
	}
...
Map<String, dynamic> searchVideoDataListToJson(SearchVideoDataList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
searchVideoDataListTagsFromJson(SearchVideoDataListTags data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['name'] != null) {
...
Map<String, dynamic> searchVideoDataListTagsToJson(SearchVideoDataListTags entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
searchVideoDataListPublisherFromJson(SearchVideoDataListPublisher data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
...
Map<String, dynamic> searchVideoDataListPublisherToJson(SearchVideoDataListPublisher entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
...
searchVideoDataListLocationFromJson(SearchVideoDataListLocation data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['city'] != null) {
...
Map<String, dynamic> searchVideoDataListLocationToJson(SearchVideoDataListLocation entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
searchVideoDataListVidStatusFromJson(SearchVideoDataListVidStatus data, Map<String, dynamic> json) {
...
Map<String, dynamic> searchVideoDataListVidStatusToJson(SearchVideoDataListVidStatus entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
searchVideoDataListCommentFromJson(SearchVideoDataListComment data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
		data.uid = json['uid'] is String
				? int.tryParse(json['uid'])
				: json['uid'].toInt();
...
Map<String, dynamic> searchVideoDataListCommentToJson(SearchVideoDataListComment entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
	data['portrait'] = entity.portrait;
...
searchVideoDataListWatchFromJson(SearchVideoDataListWatch data, Map<String, dynamic> json) {
...
Map<String, dynamic> searchVideoDataListWatchToJson(SearchVideoDataListWatch entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
