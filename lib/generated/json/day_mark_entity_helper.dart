...
dayMarkEntityFromJson(DayMarkEntity data, Map<String, dynamic> json) {
	if (json['code'] != null) {
	...
	if (json['data'] != null) {
		data.data = DayMarkData().fromJson(json['data']);
	}
	if (json['hash'] != null) {
		data.hash = json['hash'];
	}
...
Map<String, dynamic> dayMarkEntityToJson(DayMarkEntity entity) {
...
dayMarkDataFromJson(DayMarkData data, Map<String, dynamic> json) {
	if (json['list'] != null) {
		data.xList = (json['list'] as List).map((v) => DayMarkDataList().fromJson(v)).toList();
	}
	if (json['value'] != null) {
...
Map<String, dynamic> dayMarkDataToJson(DayMarkData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
dayMarkDataListFromJson(DayMarkDataList data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['prizes'] != null) {
		data.prizes = (json['prizes'] as List).map((v) => DayMarkDataListPrizes().fromJson(v)).toList();
	}
...
Map<String, dynamic> dayMarkDataListToJson(DayMarkDataList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
dayMarkDataListPrizesFromJson(DayMarkDataListPrizes data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['name'] != null) {
...
Map<String, dynamic> dayMarkDataListPrizesToJson(DayMarkDataListPrizes entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
