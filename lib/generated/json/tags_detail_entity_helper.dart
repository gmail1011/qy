...
tagsDetailEntityFromJson(TagsDetailEntity data, Map<String, dynamic> json) {
	if (json['code'] != null) {
	...
	if (json['data'] != null) {
		data.data = TagsDetailData().fromJson(json['data']);
	}
	if (json['hash'] != null) {
		data.hash = json['hash'];
	}
...
Map<String, dynamic> tagsDetailEntityToJson(TagsDetailEntity entity) {
...
tagsDetailDataFromJson(TagsDetailData data, Map<String, dynamic> json) {
	if (json['sections'] != null) {
		data.sections = (json['sections'] as List).map((v) => TagsDetailDataSections().fromJson(v)).toList();
	}
...
Map<String, dynamic> tagsDetailDataToJson(TagsDetailData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
tagsDetailDataSectionsFromJson(TagsDetailDataSections data, Map<String, dynamic> json) {
	if (json['sectionID'] != null) {
		data.sectionID = json['sectionID'].toString();
	}
	if (json['sectionName'] != null) {
		data.sectionName = json['sectionName'].toString();
	}
	if (json['videoInfo'] != null) {
		data.videoInfo = (json['videoInfo'] as List).map((v) => TagsDetailDataSectionsVideoInfo().fromJson(v)).toList();
	}
	if (json['originalBloggerInfo'] != null) {
		data.originalBloggerInfo = TagsDetailDataSectionsOriginalBloggerInfo().fromJson(json['originalBloggerInfo']);
	}
	if (json['hasFollowed'] != null) {
		data.hasFollowed = json['hasFollowed'];
	}
	if (json['sortType'] != null) {
		data.sortType = json['sortType'];
	}
	return data;
}

Map<String, dynamic> tagsDetailDataSectionsToJson(TagsDetailDataSections entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['sectionID'] = entity.sectionID;
	data['sectionName'] = entity.sectionName;
	data['videoInfo'] =  entity.videoInfo?.map((v) => v.toJson())?.toList();
	data['originalBloggerInfo'] = entity.originalBloggerInfo?.toJson();
	data['hasFollowed'] = entity.hasFollowed;
	data['sortType'] = entity.sortType;
	return data;
}

tagsDetailDataSectionsVideoInfoFromJson(TagsDetailDataSectionsVideoInfo data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['tags'] != null) {
		data.tags = (json['tags'] as List).map((v) => TagsDetailDataSectionsVideoInfoTags().fromJson(v)).toList();
	}
	...
	if (json['publisher'] != null) {
		data.publisher = TagsDetailDataSectionsVideoInfoPublisher().fromJson(json['publisher']);
	}
	if (json['location'] != null) {
		data.location = TagsDetailDataSectionsVideoInfoLocation().fromJson(json['location']);
	}
	if (json['vidStatus'] != null) {
		data.vidStatus = TagsDetailDataSectionsVideoInfoVidStatus().fromJson(json['vidStatus']);
	}
	if (json['comment'] != null) {
		data.comment = TagsDetailDataSectionsVideoInfoComment().fromJson(json['comment']);
	}
	if (json['watch'] != null) {
		data.watch = TagsDetailDataSectionsVideoInfoWatch().fromJson(json['watch']);
	}
	return data;
}

Map<String, dynamic> tagsDetailDataSectionsVideoInfoToJson(TagsDetailDataSectionsVideoInfo entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
tagsDetailDataSectionsVideoInfoTagsFromJson(TagsDetailDataSectionsVideoInfoTags data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['name'] != null) {
...
Map<String, dynamic> tagsDetailDataSectionsVideoInfoTagsToJson(TagsDetailDataSectionsVideoInfoTags entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
tagsDetailDataSectionsVideoInfoPublisherFromJson(TagsDetailDataSectionsVideoInfoPublisher data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
...
Map<String, dynamic> tagsDetailDataSectionsVideoInfoPublisherToJson(TagsDetailDataSectionsVideoInfoPublisher entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
...
tagsDetailDataSectionsVideoInfoLocationFromJson(TagsDetailDataSectionsVideoInfoLocation data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['city'] != null) {
...
Map<String, dynamic> tagsDetailDataSectionsVideoInfoLocationToJson(TagsDetailDataSectionsVideoInfoLocation entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
tagsDetailDataSectionsVideoInfoVidStatusFromJson(TagsDetailDataSectionsVideoInfoVidStatus data, Map<String, dynamic> json) {
...
Map<String, dynamic> tagsDetailDataSectionsVideoInfoVidStatusToJson(TagsDetailDataSectionsVideoInfoVidStatus entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
tagsDetailDataSectionsVideoInfoCommentFromJson(TagsDetailDataSectionsVideoInfoComment data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
		data.uid = json['uid'] is String
				? int.tryParse(json['uid'])
				: json['uid'].toInt();
...
Map<String, dynamic> tagsDetailDataSectionsVideoInfoCommentToJson(TagsDetailDataSectionsVideoInfoComment entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
	data['portrait'] = entity.portrait;
...
tagsDetailDataSectionsVideoInfoWatchFromJson(TagsDetailDataSectionsVideoInfoWatch data, Map<String, dynamic> json) {
...
Map<String, dynamic> tagsDetailDataSectionsVideoInfoWatchToJson(TagsDetailDataSectionsVideoInfoWatch entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
tagsDetailDataSectionsOriginalBloggerInfoFromJson(TagsDetailDataSectionsOriginalBloggerInfo data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
		data.uid = json['uid'] is String
				? int.tryParse(json['uid'])
				: json['uid'].toInt();
...
Map<String, dynamic> tagsDetailDataSectionsOriginalBloggerInfoToJson(TagsDetailDataSectionsOriginalBloggerInfo entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
	data['portrait'] = entity.portrait;
