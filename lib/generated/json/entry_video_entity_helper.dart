...
entryVideoEntityFromJson(EntryVideoEntity data, Map<String, dynamic> json) {
	if (json['code'] != null) {
	...
	if (json['data'] != null) {
		data.data = EntryVideoData().fromJson(json['data']);
	}
	if (json['hash'] != null) {
		data.hash = json['hash'];
	}
...
Map<String, dynamic> entryVideoEntityToJson(EntryVideoEntity entity) {
...
entryVideoDataFromJson(EntryVideoData data, Map<String, dynamic> json) {
	if (json['activityId'] != null) {
		data.activityId = json['activityId'].toString();
	}
	if (json['activityBackgroundImage'] != null) {
		data.activityBackgroundImage = json['activityBackgroundImage'].toString();
	}
	if (json['activityEndTime'] != null) {
		data.activityEndTime = json['activityEndTime'].toString();
	}
	if (json['activityDesc'] != null) {
		data.activityDesc = json['activityDesc'].toString();
	}
	if (json['workList'] != null) {
		data.workList = (json['workList'] as List).map((v) => EntryVideoDataWorkList().fromJson(v)).toList();
	}
...
Map<String, dynamic> entryVideoDataToJson(EntryVideoData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['activityId'] = entity.activityId;
	data['activityBackgroundImage'] = entity.activityBackgroundImage;
	data['activityEndTime'] = entity.activityEndTime;
	data['activityDesc'] = entity.activityDesc;
	data['workList'] =  entity.workList?.map((v) => v.toJson())?.toList();
	data['hasNext'] = entity.hasNext;
	return data;
}

entryVideoDataWorkListFromJson(EntryVideoDataWorkList data, Map<String, dynamic> json) {
	if (json['id'] != null) {
	...
	if (json['tags'] != null) {
		data.tags = (json['tags'] as List).map((v) => EntryVideoDataWorkListTags().fromJson(v)).toList();
	}
	...
	if (json['publisher'] != null) {
		data.publisher = EntryVideoDataWorkListPublisher().fromJson(json['publisher']);
	}
	if (json['location'] != null) {
		data.location = EntryVideoDataWorkListLocation().fromJson(json['location']);
	}
	if (json['vidStatus'] != null) {
		data.vidStatus = EntryVideoDataWorkListVidStatus().fromJson(json['vidStatus']);
	}
	if (json['comment'] != null) {
		data.comment = EntryVideoDataWorkListComment().fromJson(json['comment']);
	}
	if (json['watch'] != null) {
		data.watch = EntryVideoDataWorkListWatch().fromJson(json['watch']);
	}
	return data;
}

Map<String, dynamic> entryVideoDataWorkListToJson(EntryVideoDataWorkList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
entryVideoDataWorkListTagsFromJson(EntryVideoDataWorkListTags data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['name'] != null) {
...
Map<String, dynamic> entryVideoDataWorkListTagsToJson(EntryVideoDataWorkListTags entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
entryVideoDataWorkListPublisherFromJson(EntryVideoDataWorkListPublisher data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
...
Map<String, dynamic> entryVideoDataWorkListPublisherToJson(EntryVideoDataWorkListPublisher entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
...
entryVideoDataWorkListLocationFromJson(EntryVideoDataWorkListLocation data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'].toString();
	}
	if (json['city'] != null) {
...
Map<String, dynamic> entryVideoDataWorkListLocationToJson(EntryVideoDataWorkListLocation entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
entryVideoDataWorkListVidStatusFromJson(EntryVideoDataWorkListVidStatus data, Map<String, dynamic> json) {
...
Map<String, dynamic> entryVideoDataWorkListVidStatusToJson(EntryVideoDataWorkListVidStatus entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
entryVideoDataWorkListCommentFromJson(EntryVideoDataWorkListComment data, Map<String, dynamic> json) {
	if (json['uid'] != null) {
		data.uid = json['uid'] is String
				? int.tryParse(json['uid'])
				: json['uid'].toInt();
...
Map<String, dynamic> entryVideoDataWorkListCommentToJson(EntryVideoDataWorkListComment entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['uid'] = entity.uid;
	data['name'] = entity.name;
	data['portrait'] = entity.portrait;
...
entryVideoDataWorkListWatchFromJson(EntryVideoDataWorkListWatch data, Map<String, dynamic> json) {
...
Map<String, dynamic> entryVideoDataWorkListWatchToJson(EntryVideoDataWorkListWatch entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
