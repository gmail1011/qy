...
gameBillDetailEntityFromJson(GameBillDetailEntity data, Map<String, dynamic> json) {
	if (json['code'] != null) {
	...
	if (json['data'] != null) {
		data.data = GameBillDetailData().fromJson(json['data']);
	}
	if (json['hash'] != null) {
		data.hash = json['hash'];
	}
...
Map<String, dynamic> gameBillDetailEntityToJson(GameBillDetailEntity entity) {
...
gameBillDetailDataFromJson(GameBillDetailData data, Map<String, dynamic> json) {
	if (json['list'] != null) {
		data.xList = (json['list'] as List).map((v) => GameBillDetailDataList().fromJson(v)).toList();
	}
	return data;
}

Map<String, dynamic> gameBillDetailDataToJson(GameBillDetailData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['list'] =  entity.xList?.map((v) => v.toJson())?.toList();
	return data;
}

gameBillDetailDataListFromJson(GameBillDetailDataList data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> gameBillDetailDataListToJson(GameBillDetailDataList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
	data['uid'] = entity.uid;
